  ...
  return (
    <div className={cn("space-y-4", className)}>
      ...
      <div className="relative group w-full">
        ...
        <div className="relative p-3 rounded-lg border border-primary/10 bg-muted/30 w-full overflow-hidden">
          <HexColorPicker 
            color={value} 
            onChange={onChange} 
            className="w-full !h-36 !max-w-full" 
      ...
      <div className="flex items-center gap-3">
        ...
        <input
          ...
          className="flex-1 px-3 py-2.5 text-sm border-2 border-border bg-background/50 backdrop-blur-sm hover:border-primary/30 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 font-mono font-medium rounded-md"
        />
      </div>
      ...
      {showNameInput && onNameChange && (
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-3 py-2.5 text-sm border-2 border-border bg-background/50 backdrop-blur-sm hover:border-primary/30 focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all duration-200 rounded-md"
          />
        </div>
      )}
    </div>
